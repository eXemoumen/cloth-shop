            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full border border-slate-200 w-8 h-8 dark:border-slate-800"
                >
                  <img
                    src="/placeholder.svg"
                    width="32"
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Card>
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    The total revenue generated from all product sales.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    The number of customers who have made a purchase in the last
                    30 days.
                  </CardDescription>
                </CardHeader>
                <CardContent>
